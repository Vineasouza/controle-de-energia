...
void main(void) {
  ...
  while (1) {
    ...
    if (!PORTCbits.RC1 && valor_atual > 0) {
      _delay((unsigned long)((500)*(4000000/4000.0)));
      valor_atual--;
    }


    if (!PORTCbits.RC0 && valor_atual < 9) {
      _delay((unsigned long)((500)*(4000000/4000.0)));
      valor_atual++;
    }
    ...
    PORTDbits.RD0 = (acumulador % 2) ? 0 : 1;
    acumulador = acumulador / 2;

    PORTDbits.RD1 = (acumulador % 2) ? 0 : 1;
    acumulador = acumulador / 2;

    PORTDbits.RD2 = (acumulador % 2) ? 0 : 1;
    acumulador = acumulador / 2;

    PORTDbits.RD3 = (acumulador % 2) ? 0 : 1;
    acumulador = acumulador / 2;
  }
}
